 ...
 **/
package lg.flash.motion.loading.display {
 ...
 * property like <code>myContent.loader.url</code> or <code>(myContent.loader as SWFLoader).getClass("lg.flash.motion.TweenLite");</code>
 * <br /><br />
 * 
...
//---- GETTERS / SETTERS -------------------------------------------------------------------------
		 ...
		 * <code>lg.flash.motion.layout.ScaleMode</code> constants if you prefer):
		 * <ul>
		 ...
		 * <code>lg.flash.motion.layout.AlignMode</code> constants if you prefer):
		 * <ul>
