 ...
 **/
package lg.flash.motion.loading.core {
	import lg.flash.motion.events.LoaderEvent;
	import lg.flash.motion.loading.LoaderMax;
	...
	[Event(name="open", 	type="lg.flash.motion.events.LoaderEvent")]
	/** Dispatched each time the <code>bytesLoaded</code> value changes while loading (indicating progress). **/
	[Event(name="progress", type="lg.flash.motion.events.LoaderEvent")]
	/** Dispatched when the loader completes. **/
	[Event(name="complete", type="lg.flash.motion.events.LoaderEvent")]
	...
	[Event(name="cancel", 	type="lg.flash.motion.events.LoaderEvent")]
	/** Dispatched when the loader fails. **/
	[Event(name="fail", 	type="lg.flash.motion.events.LoaderEvent")]
	/** Dispatched when the loader experiences some type of error, like a SECURITY_ERROR or IO_ERROR. **/
	[Event(name="error", 	type="lg.flash.motion.events.LoaderEvent")]
/**
