...
package lg.flash.motion.loading {
	...
	import lg.flash.motion.loading.core.LoaderItem;
	...
	[Event(name="ioError", 				type="lg.flash.motion.events.LoaderEvent")]
...
import lg.flash.motion.events.LoaderEvent;
import lg.flash.motion.loading.display.~~;
 ...
 * 		<li><strong> onHTTPStatus : Function</strong> - A handler function for <code>LoaderEvent.HTTP_STATUS</code> events. Make sure your onHTTPStatus function accepts a single parameter of type <code>LoaderEvent</code> (<code>lg.flash.motion.events.LoaderEvent</code>).</li>
 ...
 * 
 * @see lg.flash.motion.loading.data.LoaderMaxVars
 * 
 * @author Jack Doyle, jack@greensock.com
 */	
	public class LoaderMax extends LoaderCore {		
		/** @private **/
		public static const version:Number = 1.71;
		...
		/** The class used by ImageLoaders, SWFLoaders, and VideoLoaders to create the containers into which they'll dump their rawContent - by default it is the <code>lg.flash.motion.loading.display.ContentDisplay</code> class but if you're using Flex, it is typically best to change this to <code>lg.flash.motion.loading.display.FlexContentDisplay</code>. You only need to do this once, like <br /><code>import lg.flash.motion.loading.LoaderMax;<br />import lg.flash.motion.loading.display.FlexContentDisplay;<br />LoaderMax.contentDisplayClass = FlexContentDisplay;</code> **/
...
import lg.flash.motion.loading.~~;
import lg.flash.motion.loading.core.~~;
import lg.flash.motion.events.LoaderEvent;
...
//---- STATIC METHODS ----------------------------------------------------------------------------
		 ...
		 * 		<li><strong> VideoLoader </strong> - A <code>lg.flash.motion.loading.display.ContentDisplay</code> (a Sprite) which contains the VideoLoader's <code>rawContent</code> (a Video object to which the NetStream was attached).</li>
		 * 		<li><strong> XMLLoader </strong> - XML</li>
		 * 		<li><strong> DataLoader </strong>
		 * 			<ul>
		 * 				<li><code>String</code> if the DataLoader's <code>format</code> vars property is <code>"text"</code> (the default).</li>
