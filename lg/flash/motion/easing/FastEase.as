 ...
 * activate them ONCE in your swf). The following easing equations from the lg.flash.motion.easing package are 
 ...
 * 
 * <code>
 * 		import lg.flash.motion.easing.*;<br /><br />
 * 		
 ...
 */
	public class FastEase {
		 ...
		 * want to activate an ease that is NOT in the lg.flash.motion.easing package (for example 
		 ...
		 * 		import lg.flash.motion.easing.FastEase;<br /><br />
		 * 
