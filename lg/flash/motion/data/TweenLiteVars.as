 ...
 **/
package lg.flash.motion.data {
	import lg.flash.motion.TweenLite;
	import lg.flash.motion.motionPaths.MotionPath;
...
//---- BUILT-IN SPECIAL PROPERTIES (NO PLUGIN ACTIVATION REQUIRED) --------------------------------------------------------------
		 ...
		 * 
		 * @param ease An easing function (i.e. <code>lg.flash.motion.easing.Elastic.easeOut</code>) The default is <code>Quad.easeOut</code>.
...
//---- PLUGIN REQUIRED -------------------------------------------------------------------------------------------
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.BezierPlugin; <br />
		 ...
		 * 		import lg.flash.motion.TweenLite; <br />
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.~~; <br />
		 * 		import lg.flash.motion.motionPaths.~~<br />
		 ...
		 * </code>
		 * 
		 * @param path The CirclePath2D instance to follow (<code>lg.flash.motion.motionPaths.CirclePath2D</code>)
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.ColorMatrixFilterPlugin; <br />
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.FramePlugin; <br />
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.HexColorsPlugin; <br />
		 ...
		 * <code>
		 * 		import lg.flash.motion.TweenLite; <br />
		 * 		import lg.flash.motion.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.Physics2DPlugin; <br />
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.PhysicsPropsPlugin; <br />
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.ScrollRectPlugin; <br />
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.SetSizePlugin; <br />
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.ShortRotationPlugin; <br />
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.SoundTransformPlugin; <br />
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.StageQualityPlugin; <br />
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.TransformAroundCenterPlugin; <br />
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.TransformAroundPointPlugin; <br />
		 ...
		 * 		import lg.flash.motion.data.TweenLiteVars; <br />
		 * 		import lg.flash.motion.plugins.TweenPlugin; <br />
		 * 		import lg.flash.motion.plugins.TransformMatrixPlugin; <br />
