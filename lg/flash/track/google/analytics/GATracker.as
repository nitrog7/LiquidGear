...
package lg.flash.track.google.analytics {
	...
	//Google
    import lg.flash.track.google.analytics.core.Buffer;
    import lg.flash.track.google.analytics.core.Ecommerce;
    import lg.flash.track.google.analytics.core.EventTracker;
    import lg.flash.track.google.analytics.core.GIFRequest;
    import lg.flash.track.google.analytics.core.IdleTimer;
    import lg.flash.track.google.analytics.core.ServerOperationMode;
    import lg.flash.track.google.analytics.core.TrackerCache;
    import lg.flash.track.google.analytics.core.TrackerMode;
    import lg.flash.track.google.analytics.core.ga_internal;
    import lg.flash.track.google.analytics.debug.DebugConfiguration;
    import lg.flash.track.google.analytics.debug.Layout;
    import lg.flash.track.google.analytics.external.AdSenseGlobals;
    import lg.flash.track.google.analytics.external.HTMLDOM;
    import lg.flash.track.google.analytics.external.JavascriptProxy;
    import lg.flash.track.google.analytics.utils.Environment;
    import lg.flash.track.google.analytics.utils.Version;
    import lg.flash.track.google.analytics.v4.Bridge;
    import lg.flash.track.google.analytics.v4.Configuration;
    import lg.flash.track.google.analytics.v4.GoogleAnalyticsAPI;
    import lg.flash.track.google.analytics.v4.Tracker;
     ...
     */
    public class GATracker extends Element {
         ...
         */
        public function GATracker(display:Sprite, account:String, mode:String='AS3', visualDebug:Boolean=false, config:Configuration=null, debug:DebugConfiguration=null) {
            _display			= display;
        ...
        private function _trackerFactory():GoogleAnalyticsAPI {
            ...
            */
            ...
            /* note:
               ...
               we need to be able to access the stage property of a VisualElement,
