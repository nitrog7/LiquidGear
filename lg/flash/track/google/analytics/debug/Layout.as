...
package lg.flash.track.google.analytics.debug
{
    ...
    public class Layout implements ILayout
    {
        ...
        private var _infoQueue:Vector.<String>		= new Vector.<String>();
        private var _warningQueue:Vector.<String>	= new Vector.<String>();
        private var _GRAlertQueue:Vector.<String>	= new Vector.<String>();
